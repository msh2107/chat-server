...
//go:generate minimock -i github.com/msh2107/chat-server/internal/service.ChatService -o ./mocks/chat_service_minimock.go -n ChatServiceMock
...
func (mmGetMessages *mChatServiceMockGetMessages) Expect(ctx context.Context, chatID int64, limit int64) *mChatServiceMockGetMessages {
	...
	mmGetMessages.defaultExpectation.params = &ChatServiceMockGetMessagesParams{ctx, chatID, limit}
...
func (mmGetMessages *mChatServiceMockGetMessages) Inspect(f func(ctx context.Context, chatID int64, limit int64)) *mChatServiceMockGetMessages {
...
func (mmGetMessages *mChatServiceMockGetMessages) Set(f func(ctx context.Context, chatID int64, limit int64) (ma1 []model.Message, err error)) *ChatServiceMock {
	if mmGetMessages.defaultExpectation != nil {
...
// Then helper
func (mmGetMessages *mChatServiceMockGetMessages) When(ctx context.Context, chatID int64, limit int64) *ChatServiceMockGetMessagesExpectation {
	if mmGetMessages.mock.funcGetMessages != nil {
		mmGetMessages.mock.t.Fatalf("ChatServiceMock.GetMessages mock is already set by Set")
	}
	...
	expectation := &ChatServiceMockGetMessagesExpectation{
		...
		params: &ChatServiceMockGetMessagesParams{ctx, chatID, limit},
	}
...
func (mmGetMessages *ChatServiceMock) GetMessages(ctx context.Context, chatID int64, limit int64) (ma1 []model.Message, err error) {
	...
	mm_params := &ChatServiceMockGetMessagesParams{ctx, chatID, limit}
	...
	if mmGetMessages.GetMessagesMock.defaultExpectation != nil {
		...
		mm_got := ChatServiceMockGetMessagesParams{ctx, chatID, limit}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmGetMessages.t.Fatalf("Unexpected call to ChatServiceMock.GetMessages. %v %v %v", ctx, chatID, limit)
	return
}
...
func (mmSendMessage *mChatServiceMockSendMessage) Expect(ctx context.Context, message *model.MessageInfo) *mChatServiceMockSendMessage {
...
func (mmSendMessage *mChatServiceMockSendMessage) Inspect(f func(ctx context.Context, message *model.MessageInfo)) *mChatServiceMockSendMessage {
...
func (mmSendMessage *mChatServiceMockSendMessage) Set(f func(ctx context.Context, message *model.MessageInfo) (err error)) *ChatServiceMock {
	if mmSendMessage.defaultExpectation != nil {
...
// Then helper
func (mmSendMessage *mChatServiceMockSendMessage) When(ctx context.Context, message *model.MessageInfo) *ChatServiceMockSendMessageExpectation {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ChatServiceMock.SendMessage mock is already set by Set")
	}
...
func (mmSendMessage *ChatServiceMock) SendMessage(ctx context.Context, message *model.MessageInfo) (err error) {
