...
//go:generate minimock -i github.com/msh2107/chat-server/internal/client/db.QueryExecer -o ./mocks/query_execer_minimock.go -n QueryExecerMock
...
import (
	...
	mm_db "github.com/msh2107/chat-server/internal/client/db"
)
